...
let kidArticles = document.querySelector('#pets');

kids.forEach(kid => {
    let kids = document.createElement('article');
    let h3 = document.createElement('h3');
    let p = document.createElement('p');
    h3.appendChild(document.createTextNode(kid.owner));
    p.appendChild(document.createTextNode(kid.petName));
    kids.appendChild(h3);
    kids.appendChild(p);
    kidArticles.appendChild(kids);
